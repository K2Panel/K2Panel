...
class main:  # line:12
    ...
    def get_all_host_stats(O0000O0000OO0O000, O000O0O00OO00O00O):  # line:26
        ...
        for O00O0OO00O0O000O0 in OO000O0OO0O0O0000:  # line:33
            O0OO00O0O00O0000O = threading.Thread(
                target=O000O0O00OO00O00O, args=(O00O0OO00O0O000O0,)
            )  # line:34
    ...
    def container_status_for_all_hosts(OO0O00OO0O0OOOO0O, OOOOOOO000OO0OOO0):  # line:39
        ...
        for O00OOOOOOOO00OOO0 in O0O0O0O000O00O0OO["container_list"]:  # line:49
            ...
            O000OO000O0O00O00.save_date = (
                OO0O00OO0O0OOOO0O.__OOOOO0OOO0OO00O00
            )  # line:52
    ...
    def container_count(OO0000O0O0O0OOO00):  # line:57
        ...
        O0000000000000000 = {
            "time": int(time.time()),
            "container_count": O0O00O00O0O00OOO0,
        }  # line:69
        OOOOO0OO00OOO0O0O = time.time() - (
            OO0000O0O0O0OOO00.__OOOOO0OOO0OO00O00
            * OO0000O0O0O0OOO00.__OOOOOO0OO0OOOOOO0
        )  # line:70
        dp.sql("container_count").where(
            "time<?", (OOOOO0OO00OOO0O0O,)
        ).delete()  # line:71
    ...
    def image_for_all_host(OO0O00O000OO00O0O):  # line:75
        ...
        O0OO0O00O000000OO = {
            "time": int(time.time()),
            "num": OOO0OOO00O000OOOO,
            "size": int(O0O00000OO0O0O000),
        }  # line:93
        O0O000O00OO0OO0O0 = time.time() - (
            OO0O00O000OO00O0O.__OOOOO0OOO0OO00O00
            * OO0O00O000OO00O0O.__OOOOOO0OO0OOOOOO0
        )  # line:94
...
def monitor():  # line:99
    while True:  # line:102
        ...
        O000OO0O0O0OO0000.get_all_host_stats(
            O000OO0O0O0OO0000.container_status_for_all_hosts
        )  # line:105
        O0000OO0000000O00 = threading.Thread(
            target=O000OO0O0O0OO0000.container_count
        )  # line:107
        O0000OO0000000O00.setDaemon(True)  # line:108
        O0000OO0000000O00.start()  # line:109
        O0000OO0000000O00 = threading.Thread(
            target=O000OO0O0O0OO0000.image_for_all_host
        )  # line:111
