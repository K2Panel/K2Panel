...
class main:  # line:1
    ...
    def get_volume_container_name(O0O000O0OOO00O0O0, O0O00OOOOO0O0O00O):  # line:10
        OO000OO00OOOOOOO0 = O0O000O0OOO00O0O0.docker_client(
            O0O000O0OOO00O0O0.__O0O0O00O00OOO00O0
        ).containers  # line:11
        O0O0OOOO00000OO0O = OO000OO00OOOOOOO0.list(all=True)  # line:12
        O0000O00OOOO00O00 = [
            O000OO00OOOO00O0O.attrs for O000OO00OOOO00O0O in O0O0OOOO00000OO0O
        ]  # line:14
        for O00OOO00000OO0OOO in O0000O00OOOO00O00:  # line:15
            ...
            for O0O00O0O0OOO000OO in O00OOO00000OO0OOO["Mounts"]:  # line:18
                ...
                if O0O00OOOOO0O0O00O["Name"] == O0O00O0O0OOO000OO["Name"]:  # line:21
                    O0O00OOOOO0O0O00O["container"] = O00OOO00000OO0OOO["Name"].replace(
                        "/", ""
                    )  # line:22
    ...
    def get_volume_list(O0O0OOO0OO000000O, OO0OO0O0OOOO0OO0O):  # line:27
        ...
        O0O0O0OOO0OOO0O00 = O0O0OOO0OO000000O.docker_client(
            OO0OO0O0OOOO0OO0O.url
        )  # line:34
        ...
        if not O0O0O0OOO0OOO0O00:  # line:38
            O000O0000OOO000OO = {
                "volume": [],
                "installed": OO0OO00000OOOOOO0,
                "service_status": OOOOO0OOOO000OOOO,
            }  # line:43
            return public.returnMsg(True, O000O0000OOO000OO)  # line:44
        OO00O00OOO0O000O0 = O0O0O0OOO0OOO0O00.volumes  # line:45
        O000O0000OOO000OO = {
            "volume": O0O0OOO0OO000000O.get_volume_attr(OO00O00OOO0O000O0),
            "installed": OO0OO00000OOOOOO0,
            "service_status": OOOOO0OOOO000OOOO,
        }  # line:51
    ...
    def get_volume_attr(O00O000OO00000O00, O0O0OO0OO0OO0O0OO):  # line:54
        ...
        for OO0OOOOOOOOO0OO00 in OOO00O0O0000O0O0O:  # line:57
            OO0OOOOOOOOO0OO00 = O00O000OO00000O00.get_volume_container_name(
                OO0OOOOOOOOO0OO00.attrs
            )  # line:58
    ...
    def add(O000O0OOOO0O0OOOO, O0OO00O0O0OO0O0OO):  # line:62
        """"""  # line:70
        O000O0OOOO0O0OOOO.docker_client(O0OO00O0O0OO0O0OO.url).volumes.create(
            name=O0OO00O0O0OO0O0OO.name,
            driver=O0OO00O0O0OO0O0OO.driver,
            driver_opts=(
                O0OO00O0O0OO0O0OO.driver_opts if O0OO00O0O0OO0O0OO.driver_opts else None
            ),
            labels=dp.set_kv(O0OO00O0O0OO0O0OO.labels),
        )  # line:76
        dp.write_log(
            "Adding storage volume [[]] succeeded!".format(O0OO00O0O0OO0O0OO.name)
        )  # line:77
    ...
    def remove(O0OOO000000OO0OOO, O0OO00OO0OOO00000):  # line:80
        """"""  # line:86
        try:  # line:87
            O0000O0OO000O0O0O = O0OOO000000OO0OOO.docker_client(
                O0OO00OO0OOO00000.url
            ).volumes.get(
                O0OO00OO0OOO00000.name
            )  # line:88
            O0000O0OO000O0O0O.remove()  # line:89
            dp.write_log(
                "Delete storage volume [[]] successful!".format(O0OO00OO0OOO00000.name)
            )  # line:90
            ...
            if "volume is in use" in str(OO00OO0O000O0O0O0):  # line:93
                return public.returnMsg(
                    False, "Storage volume is in use and cannot be deleted!"
                )  # line:94
            return public.returnMsg(
                False, "Failed to delete! {}".format(OO00OO0O000O0O0O0)
            )  # line:95
