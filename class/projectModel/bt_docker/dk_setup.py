...
class main:  # line:1
    def get_config(O0OO0OO0O0OOO0OOO, O0OOOO000OOOO0000):  # line:3
        ...
        O00O0OOO0O0O0OO00 = O0OO0OO0O0OOO0OOO.get_registry_mirrors(
            O0OOOO000OOOO0000
        )  # line:6
        ...
        return public.returnMsg(
            True,
            {
                "registry_mirrors": O00O0OOO0O0O0OO00,
                "service_status": OOO00O00O00000000,
                "installed": O0OO0OO0O0OOO0OOO.check_docker_program(),
                "monitor_status": O0OO0OO0O0OOO0OOO.get_monitor_status(),
    ...
    def set_monitor_save_date(O0OO0000000O0OO0O, OO0OO0O0O00OO0OOO):  # line:20
        ...
        OOOO0O0OO00O00O00 = "{}/data/docker.conf".format(
        ...
        try:  # line:29
            ...
            return public.returnMsg(
                False, "The monitoring save time needs to be a positive integer!"
            )  # line:32
        if OOO00O0000000OO0O > 999:  # line:33
            return public.returnMsg(
                False, "Monitoring data cannot be retained for more than 999 days!"
            )  # line:34
        ...
        O00OO000O0OO0000O = re.sub(
            r"SAVE\s*=\s*\d+", "SAVE={}".format(OOO00O0000000OO0O), O00OO000O0OO0000O
        )  # line:39
        public.writeFile(OOOO0O0OO00O00O00, O00OO000O0OO0000O)  # line:40
        dp.write_log(
            "Set the monitoring time to [] days!".format(OOO00O0000000OO0O)
        )  # line:41
    ...
    def docker_service(O00OOO000O0000O0O, OOO00OO000000OOOO):  # line:60
        ...
        O0000OO0O0OOOOOO0 = "systemctl {} docker".format(
            OOO00OO000000OOOO.act
        )  # line:70
        if OOO00OO000000OOOO.act == "stop":  # line:71
            O0000OO0O0OOOOOO0 += "&& systemctl {} docker.socket".format(
                OOO00OO000000OOOO.act
            )  # line:72
        public.ExecShell(O0000OO0O0OOOOOO0)  # line:73
        dp.write_log(
            "Set the Docker service status to [{}] successful".format(
                O000O0OOO0O0O000O[OOO00OO000000OOOO.act]
            )
        )  # line:74
        return public.returnMsg(
            True,
            "Set the status to [{}] successful".format(
                O000O0OOO0O0O000O[OOO00OO000000OOOO.act]
            ),
        )  # line:75
    ...
    def get_registry_mirrors(O000O0OO0O00O0000, OO00O0OOO000O00O0):  # line:78
        try:  # line:79
            ...
            O00000OOOOOOOO0O0 = json.loads(
                public.readFile("/etc/docker/daemon.json")
            )  # line:82
            if "registry-mirrors" not in O00000OOOOOOOO0O0:  # line:83
                return public.returnMsg(True, [])  # line:84
            return public.returnMsg(
                True, O00000OOOOOOOO0O0["registry-mirrors"]
            )  # line:85
        except:  # line:86
            return public.returnMsg(
                False,
                "Get failed! Reason for failure: {}".format(public.get_error_info()),
            )  # line:87
    ...
    def set_registry_mirrors(OO0OO0000OO0OOOO0, OOOO000OO0O00O000):  # line:90
        ...
        try:  # line:97
            ...
            if not OOOO000OO0O00O000.registry_mirrors_address.strip():  # line:101
                ...
                O0O0O0O00OOOO0O0O = (
                    OOOO000OO0O00O000.registry_mirrors_address.strip().split("\n")
                )  # line:107
                for O0000OOO0OO0000O0 in O0O0O0O00OOOO0O0O:  # line:108
                    if not re.search("https?://", O0000OOO0OO0000O0):  # line:109
                        return public.returnMsg(
                            False,
                            "The acceleration address [{}] is malformed<br>Reference: https://mirror.ccs.tencentyun.com".format(
                                O0000OOO0OO0000O0
                            ),
                        )  # line:110
                O0000O0O0O000O00O["registry-mirrors"] = O0O0O0O00OOOO0O0O  # line:112
            public.writeFile(
                "/etc/docker/daemon.json", json.dumps(O0000O0O0O000O00O, indent=2)
            )  # line:115
            ...
            return public.returnMsg(
                False,
                "Setup failed! Reason for failure:{}".format(public.get_error_info()),
            )  # line:119

    def get_monitor_status(OO0O00O0OO0O0O000):  # line:121
        """"""  # line:124
        O00O000O00OO00000 = public.process_exists(
            "python",
            cmdline="/www/server/panel/class/projectModel/bt_docker/dk_monitor.py",
        )  # line:126
    ...
    def set_docker_monitor(OO0OOOOOOO0O00OO0, O0O0O0000O0OOO000):  # line:134
        ...
        O0O000O0O00O0O000 = (
            "/www/server/panel/class/projectModel/bt_docker/dk_monitor.py"  # line:145
        )
        if O0O0O0000O0OOO000.act == "start":  # line:146
            OOO0O00OO0OO0O00O = "nohup {} {} &".format(
                OOO000O0O0O0OOOO0, O0O000O0O00O0O000
            )  # line:147
            ...
            if OO0OOOOOOO0O00OO0.get_monitor_status():  # line:150
                ...
                return public.returnMsg(
                    True, "Start monitoring successfully!"
                )  # line:152
            return public.returnMsg(False, "Failed to start monitoring!")  # line:153
        else:  # line:154
            O0O0OOOOOOOO0O0OO = dp.get_process_id(
                "python", "/www/server/panel/class/projectModel/bt_docker/dk_monitor.py"
            )  # line:155
    ...
    def check_docker_program(O0O00O00OOOO0O000):  # line:162
        ...
        if not os.path.exists(O0O0O00O000OOO000) or not os.path.exists(
            O00OO00OO0OOOOOO0
        ):  # line:169
    ...
    def install_docker_program(OOO0000OOO0O0O0O0, O0O000O0OO000OO0O):  # line:173
        ...
        public.httpPost(
            ...
            {"pid": "1111111", "p_name": "Docker商用模块"},
            3,
        )  # line:185
        public.arequests(
            "post",
            "{}/api/setupCount/setupPlugin".format(public.OfficialApiBase()),
            data={"pid": "1111111", "p_name": "Dockerpaymodel"},
            timeout=3,
        )
