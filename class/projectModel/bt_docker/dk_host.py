...
class main:  # line:4
    ...
    def add(O0OO00O0O000O0000, O00O0000O00000O0O):  # line:17
        ...
        if not dp.docker_client(O00O0000O00000O0O.url):  # line:29
            return public.returnMsg(
                False,
                "Failed to connect to the server, please check if docker has been started!",
            )  # line:30
        O0O0OO0OOOOO0OOO0 = {
            "url": O00O0000O00000O0O.url,
            "remark": O00O0000O00000O0O.remark,
            "time": int(time.time()),
        }  # line:35
        dp.write_log(
            "Add host [{}] successful!".format(O00O0000O00000O0O.url)
        )  # line:36
    ...
    def delete(O0OOOO0000000O00O, O0O0O0O000000OOOO):  # line:40
        ...
        dp.write_log(
            "Delete host [{}] succeeded!".format(OOO00OO0OO0OOO00O["url"])
        )  # line:47
