...
class feishu_msg:
    ...
    def __init__(self):
        try:
            ...
            if (
                not "feishu_url" in self.__feishu_info
                or not "isAtAll" in self.__feishu_info
                or not "user" in self.__feishu_info
            ):
    ...
    def send_msg(self, msg, to_user="default"):
        ...
        if not self.__feishu_info:
            return public.returnMsg(
                False, public.lang("Feishu information is not configured correctly.")
            )
