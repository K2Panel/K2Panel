...
class sms_msg:
    ...
    def set_config(self, get):
        ...
        if "login" in get:
            ...
            if is_login and not self.__check_auth_path():
                return public.returnMsg(
                    False,
                    public.lang(
                        "Security entry complexity is not enough <br>1, length must not be less than 9 <br>2, English + digital combination."
                    ),
                )
            data["login"] = is_login
