        ...
        if data['type'] in ['ssl']:
            ...
            if len(web_list) > 0:
                for m_module in data['module'].split(','):
                    ...
                    sdata = public.get_push_info('K2Panel Website Expiration Reminder',s_list)
                    result[m_module] = sdata
                return result
            ...
            if res['expire'] > 0 and res['expire_day'] < data['cycle']:
                for m_module in data['module'].split(','):
                    ...
                    sdata = public.get_push_info('K2Panel password expiration reminder',s_list)
                    result[m_module] = sdata
                return result
        ...
        for m_module in data['module'].split(','):
            if m_module in self.__push_model:
                ...
                if m_module in ['sms']:
                    ...
                    sdata = public.get_push_info('K2Panel SSL expiration reminder',s_list)
