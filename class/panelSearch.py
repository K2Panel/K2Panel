...
class panelSearch:
    ...
    def get_search(self, args):
        ...
        if "exts" not in args or not args.exts:
            return {
                "error": public.lang(
                    "The suffix cannot be empty; please enter [ *.* ] to search all files"
                )
            }
        ...
        is_tmpe_files = self.get_exts_files(
            path, exts, text, mode, isword, iscase, noword, is_subdir, get=args
        )
    ...
    def get_replace(self, args):
        ...
        if "rtext" not in args or not args.text:
            return {"error": public.lang("The content to be replaced cannot be empty")}
        if "exts" not in args or not args.exts:
            return {
                "error": public.lang(
                    "The suffix cannot be empty; please enter [ *.* ] to search all files"
