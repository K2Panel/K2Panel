                    ...
                    if result[0] == "4" and result[1] == "18" and result[2] == "0":
                        if len(result[3]) <= 3:
                            ...
                            if not fin:
                                return (
                                    False,
                                    "The current kernel version [{}] has security risks, please upgrade to 4.18.0-425 and above as soon as possible".format(
                                        kernel
                                    ),
                                )
                    ...
                    if result[0] == "5" and result[1] == "15" and result[2] == "0":
                        if len(result[3]) <= 3:
                            ...
                            if not fin:
                                return (
                                    False,
                                    "The current kernel version [{}] has security risks, please upgrade to 5.15.0-70 and above as soon as possible".format(
                                        kernel
                                    ),
                                )
