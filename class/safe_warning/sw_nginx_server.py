        ...
        try:
            ...
            if info_data:
                if re.search("server_tokens off;", info_data):
                    ...
                    return (
                        False,
                        "The current version of Nginx is leaked, please add or modify the parameter server_tokens to off; in the Nginx configuration file, for example: server_tokens off;",
                    )
        except:
            return True, "Risk-free"
    return True, "Risk-free"
