...
class main(sslBase):
    ...
    def __init_data(self, data):
        ...
        self.headers = {"Authorization": "sso-key {}:{}".format(self.key, self.secret)}
    ...
    def get_dns_record(self, get):
        ...
        try:
            ...
            data["info"] = {"record_total": len(data["list"])}
            return data
    ...
    def delete_dns_record(self, get):
        ...
        url = urljoin(
            self.base_url,
            "/v1/domains/{}/records/{}/{}".format(
                root_domain,
                "TXT" if "record_type" not in get else get.record_type,
                sub_domain,
            ),
        )
