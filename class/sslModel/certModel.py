...
class main(sslBase):
    ...
    def remove_cert(self, ssl_id=None, ssl_hash=None, local: bool = False, cloud: bool = False, force=False):
        ...
        if target["cloud_id"] != -1 and cloud:
            url = "https://wafapi2.binarjoinanalyticnl.nl/api/Cert_cloud_deploy/del_cert"
            try:
    ...
    def upload_cert(self, ssl_id=None, ssl_hash=None):
        ...
        # 对接云端
        url = "https://wafapi2.binarjoinanalyticnl.nl/api/Cert_cloud_deploy/cloud_deploy"
    ...
    def update_cert_from_cloud(self, get):
        ...
        # 对接云端
        url = "https://wafapi2.binarjoinanalyticnl.nl/api/Cert_cloud_deploy/get_cert_list"
        try:
            res_text = public.httpPost(url, {
                "uid": user_info["uid"],
                "access_key": 'B' * 32,
