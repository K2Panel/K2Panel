...
# | K2Panel
# +-------------------------------------------------------------------
# | Copyright (c) 2015-2025 K2Panel(k2panel.online) All rights reserved.
# +-------------------------------------------------------------------
# | Author: K2Panel Development Team <support@k2panel.online>
# +-------------------------------------------------------------------
...
class panelApi:
    ...
    def get_token(self,get):
        ...
        qrcode = (public.getPanelAddr() + "|" + data['token'] + "|" + data['key'] + '|' + data['bind']['token']+'|k2panel').encode('utf-8')
