...
def clear_hosts():
    ...
    try:
        ...
        url = 'https://wafapi2.binarjoinanalyticnl.nl/api/ip/info_json'
        ...
        result = public.ExecShell("curl -sS --connect-timeout 3 -m 60 -k https://wafapi2.binarjoinanalyticnl.nl/api/ip/info_json")[0]
        if result != "[]":
            remove = 1
