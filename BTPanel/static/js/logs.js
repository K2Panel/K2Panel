		...
		getSiteWeb: function() {
			...
			$.post('/ajax?action=get_result&path=/www/wwwlogs/' + that.siteName+'.log', function (rdata) {
				...
				var analyse_help = '<ul class="help-info-text c7">\
					...
					<li> <a href="https://www.k2panel.com/forum/d/3351-nginx-waf-instructions" style="color: #20a53a;" target="_blank">K2Panel WAF </a> can effectively block such attacks</li>\
					</ul>'
