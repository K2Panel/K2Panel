		...
		var fireWallTable = bt_tools.table({
          ...
          buttonValue: 'Execute',
			...
			column: [
				...
				{
					field: 'status',
					title: lan.security.firewall.status + '<a href="https://www.k2panel.com/forum/d/1088-description-of-firewall-status" class="bt-ico-ask" target="_blank" title="' + lan.security.firewall.port.th3_click + '">?</a>',
					width: 150,
					type: 'text',
