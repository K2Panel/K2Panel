...
var index = {
		...
		bt.system.check_update(function (rdata) {
			...
			if (isOld) {
				content =
					...
					'<a href="https://www.k2panel.com/forum/d/9-k2panel-linux-panel-6-1-5-installation-tutorial/36" target="_blank" class="btlink" title="' +
	...
	open_log: function () {
		...
		$.get(
			'https://wafapi2.k2panel.com/api/panel/updateLinuxEn',
			function (rdata) {
				var body = '';
				for (var i = 0; i < rdata.length; i++) {
					body +=
