	...
	layer.open({
		...
		content: '<div class="bt-form pd20 pd70" style="padding:20px 35px;">\
                ...
                <div class="details" style="margin-top:5px;padding-left: 3px;">\
					...
					<label style="font-weight: 400;margin: 3px 5px 0px;" for="check_port">I already understand</label>,<a target="_blank" class="btlink" href="https://www.k2panel.com/forum/d/599-how-to-release-the-k2panel-port">How to release the port?</a>\
				</div>\
			</div>',
		...
		layer.open({
			...
			content: '<div class="bt-form pd20 pd70 ssl_cert_from google_verify" style="padding:20px 35px;">\
				...
				<div class="details" style="width: 90%;margin-bottom:10px;">\
					...
					<a target="_blank" class="btlink" href="https://www.k2panel.com/forum/d/357-how-to-use-google-authenticator-in-the-k2panel">Learn more</a>\
				</div>\
	...
	layer.open({
        ...
        content: '<div class="bt-form pd20" style="padding:20px 35px;">\
					...
					<div class="verify_tips">\
						<p>Tips: Please use the "Google Authenticator APP" binding to support Android, IOS system.<a href="https://www.k2panel.com/forum/d/357-how-to-use-google-authenticator-in-the-k2panel" class="btlink" target="_blank">Use tutorial</a></p>\
                        ...
                        html: '\
                            <div style="position: relative; width: 90%; margin: 0 auto;">\
                                ...
                                <ul style="width: 100%;">\
                                    ...
                                    <li>If panel is not accessible, you can click the <a class="btlink" href="https://www.k2panel.com/forum/d/167-common-problems-after-opening-the-panel-certificate" target="_blank">link</a> below to find solutions</li>\
                                </ul>\
                            </div>\
                        '
                    },
                    ...
                    },
                    {
                        html: '\
                            <div class="details" style="width: 90%; padding-top: 15px;">\
                                ...
                                <a class="btlink" style="top: 0;" href="https://www.k2panel.com/forum/d/167-common-problems-after-opening-the-panel-certificate" target="_blank">' + lan.config.ssl_open_ps_5 + '</a>\
                            </div>\
                        '
                    }
        ...
        layer.open({
			...
			content: ' <div class="bt-form bt-form" style="padding:15px 25px">\
                        ...
                        <ul class="help-info-text c7">\
                            ...
                            <li>'+lan.config.help3+'：<a class="btlink" href="https://www.k2panel.com/forum/d/482-api-interface-tutorial" target="_blank">https://www.k2panel.com/forum/d/482-api-interface-tutorial</a></li>\
                        </ul>\
                    </div>'
        })
    });
