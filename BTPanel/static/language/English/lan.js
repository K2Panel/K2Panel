var lan = {
	...
	"index":{
		...
		"bind_bt_account_first":"Please bind your K2Panel account first!",
		...
		"update":"Update",
		"find_bug_reward":"Find bugs, get K2Panel coins",
	...
	"config":{
		...
		"config_user_binding":"Binding your K2Panel account",
		"config_user_edit":"Change K2Panel account",
		"binding":"Bind",
		"token_get":"Getting token...",
		"user_bt":"Username",
		"pass_bt":"Password",
		"binding_un_msg":"Are you sure to unbind K2Panel account？",
		...
		"open_small_app":"Open the K2Panel panel Mini Program",
		"qrcore_of_small_app":"QR code of Mini Program",
		"scan_qrcore_with_small_app":"Use K2Panel Mobile to scan the current QR code to bind the panel",
		"return_bind_list":"Return to the panel binding list",
		"read_bind_list":"View binding list",
		"bind_wechat":"Bind WeChat",
		"no_bind_bt_account":"K2Panel account NOT bound",
	...
	"firewall":{
		...
		"bt_default_port":"Default port of K2Panel",
	...
	"bt":{
		...
		"panel_add":"Add K2Panel association",
	...
	"files":{
		...
		"swap_file":"PS: SWAP swap partition file set by default by K2Panel",
		...
		"ps_swap":"PS: K2Panel default swap virtual RAM file",
		...
		"upload_files_tips1":"PS: K2Panel file upload temporary file, re-upload resume from breakpoint, can be deleted",
	...
	"soft":{
		...
		"bt_developer":"Security Reminder: K2Panel officially conducted a security audit before the third-party plug-in was put on the shelves, but there may be security risks. Please check it out before using it in the production environment.",
		...
		"author":"Author",
		"source":"Source",
		"third_party_apps_tips1":"This is a plugin developed by a third party, K2Panel can not verify its reliability!",
...
"ssl_save":"Save and enable SSL",
		...
		"bt_bind_no":"Not bound to K2Panel account, please register and bind. After binding K2Panel account (non-forum account), you can deploy SSL with one click",
		"bt_user":"K2Panel Account",
		"bt_user_first":"Account",
		"login":"Login",
		"bt_reg":"Register K2Panel account",
		"bt_ssl_help_1":"K2Panel SSL certificate is issued by TrustAsia, requires real name identification",
		"bt_ssl_help_2":"If you have K2Panel account, please log in and bind it",
		"bt_ssl_help_3":"K2Panel SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for K2Panel users!",
		...
		"bt_ssl_help_6":"K2Panel SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
        ...
        "ssl_tips2": "K2Panel SSL applys for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
        ...
        "ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.bt.cn/yunwei' target='_blank'>K2Panel provides certificate deployment service 50 yuan Once</a>",
"ssl_tips7": "When no SSL default site is specified, a site without SSL will use HTTPS to access the site with SSL enabled",
        ...
        "dns_check_tips3": "Before using the [K2Panel DNS Cloud Resolution] API, you need to confirm that the domain DNS for which you want to apply for SSL certificate is [Cloud Resolution]",
        ...
        "dns_resolve_tips3": "If you are using the K2Panel Cloud Resolution plugin, Ali Cloud DNS,DNSPod as a DNS, you can set auto-resolution with the DNS API",
		...
		"set_ssl": {
			...
			"official_use":"Official recommendation (k2panel.com is also used)",
			...
			"bus_tip3":"Apply for www.k2panel.com certificate with www as the secondary domain name, binding and resolving the top-level domain (k2panel.com) is required, otherwise the verification will fail",
			"bus_tip4":"Compared with ordinary certificates, commercial certificates have higher security, compensation protection and support for wildcard and multi-domain names <a class=\"btlink\" href=\"https://www.k2panel.com/forum/d/19277-business-ssl-certificate-tutorial\" target=\"_blank\">how to validate the commercial certificate?</a>",
	...
	"public_backup":{
		...
		"cp_success":"Successfully copied",
		"cp_fail":"Failed to copy, browser is not compatible!",
		"bind_bt_account":"Bind K2Panel account",
		...
		"cancel":"Cancel",
		"unbind":"Unbind",
		"open_bt_small_app":"Open the K2Panel panel mini program",
		"app_qr_core":"Mini program QR code",
		"scan_qr_core":"Use K2Panel Mobile to scan the current QR code and bind to the panel",
    ...
    "year3": "3 years",
    "permanent": "Permanent",
    "buy_multiplev_bt_pro": "Note: If you need to purchase multiple permanent licenses, please visit the K2Panel official site to purchase",
    "goto_bt": "Go to K2Panel official site",
	...
	"login":{
		"qr_core_login":"K2Panel Mobile QR code login",
		"open":"Open",
		"bt_small_p":"K2Panel Mobile",
	...
	"webhook":{
		...
		"read_key":"View key",
		"test":"Test",
		"use_method":"How to use K2Panel WebHook:",
