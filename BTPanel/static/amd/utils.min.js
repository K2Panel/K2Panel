			...
			if (my_headers) {
				$.ajaxSetup({
					...
					<ul class="help-info-text">\
						...
						<li style="list-style: none;">2. If the above attempts fail to resolve this error, please screenshot this window and post it to the Pagoda Forum for help, forum address:<a class="btlink" href="https://www.k2panel.com/forum" target="_blank">https://www.k2panel.com/forum</a></li>\
					</ul>\
				</div>';
							} else {
				...
				content: {
					...
					template: function () {
						return (0, snabbdom_2.jsx)(
							...
							(0, snabbdom_2.jsx)('p', { class: { 'text-right': true } }, ' ', this.$link({ title: lan.public_backup.no_account, href: 'https://brandnew.k2panel.com/user_admin/register' }))
						);
					},
					methods: {
