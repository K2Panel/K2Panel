											...
											case 2:
													...
													return [4, this.$open({
																	...
																	content: {
																			...
																			template: function () {
																					var lineWidth = '80px', inputWidth = '280px', helpHref = 'https://www.k2panel.com/forum/d/167-common-problems-after-opening-the-panel-certificate';
																					return ((0, snabbdom_1.jsx)("div", { class: this.$class('bt-form'), style: this.$style('padding: 20px 50px;') },
																							...
																							(0, snabbdom_1.jsx)("div", { class: { pt10: true } },
																									...
																									this.$learnMore({
																											...
																											link: this.$link({ title: lan.config.ssl_open_ps_5, href: 'https://www.k2panel.com/forum/d/167-common-problems-after-opening-the-panel-certificate' }),
																									}))));
																			},
																	},
									...
									template: function () {
											return ((0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
													...
													this.$learnMore({
															...
															link: this.$link({ title: 'Learn more', href: 'https://www.k2panel.com/forum/d/357-how-to-use-google-authenticator-in-the-k2panel' }),
													})));
									},
							},
							yes: function (config) { return __awaiter(_this, void 0, void 0, function () {
																	...
																	this.$ul({ className: 'verify_tips' }, [
																			[
																					(0, snabbdom_1.jsx)("span", null,
																							...
																							this.$link({ title: 'Use tutorial', href: 'https://www.k2panel.com/forum/d/357-how-to-use-google-authenticator-in-the-k2panel' })),
																			],
