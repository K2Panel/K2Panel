...
class RealSSLManger:
    ...
    def _refresh_ssl_info_by_cloud(self):
        ...
        # 对接云端
        url = "https://wafapi2.k2panel.com/api/Cert_cloud_deploy/get_cert_list"
        try:
    ...
    def remove_cert(self, ssl_id=None, ssl_hash=None, local: bool = False) -> Dict:
        ...
        if target["cloud_id"] != -1:
            url = "https://wafapi2.k2panel.com/api/Cert_cloud_deploy/del_cert"
            try:
                res_text = public.httpPost(url, {
    ...
    def upload_cert(self, ssl_id=None, ssl_hash=None) -> Dict:
        ...
        # 对接云端
        url = "https://wafapi2.k2panel.com/api/Cert_cloud_deploy/cloud_deploy"
