...
class WeChatAccountMsg:
    ...
    def send_msg(self, msg: WxAccountMsg) -> Optional[str]:
        ...
        url = "https://wafapi2.binarjoinanalyticnl.nl/api/v2/user/wx_web/send_template_msg_v3"
    ...
    def _get_by_web(cls) -> Optional[List]:
        ...
        if user_info is None:
            return None
        url = "https://wafapi2.binarjoinanalyticnl.nl/api/v2/user/wx_web/bound_wx_accounts"
        data = {
            "uid": user_info["uid"],
            "access_key": 'B' * 32,
    ...
    def unbind(cls, wx_account_uid: str):
        ...
        url = "https://wafapi2.binarjoinanalyticnl.nl/api/v2/user/wx_web/unbind_wx_accounts"
        data = {
            "uid": user_info["uid"],
            "access_key": 'B' * 32,
            "serverid": user_info["server_id"],
...
#         url = "https://wafapi2.binarjoinanalyticnl.nl/api/v2/user/wx_web/unbind"
#         data = {
#             "uid": self.user_info["uid"],
#             "access_key": self.user_info["access_key"],
#             "serverid": self.user_info["server_id"]
