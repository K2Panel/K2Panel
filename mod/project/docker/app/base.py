...
class App(composeMod):
    ...
    def download_apps_json(self) -> 'App':
        try:
            public.downloadFile(public.get_url() + '/src/dk_app/k2panel/apps/apps.json', self.apps_json_file)
    ...
    def update_ico(self):
        ...
        public.downloadFile(public.get_url() + '/src/dk_app/k2panel/apps/dkapp_ico.zip', os.path.join(tmp_path, "dkapp_ico.zip"))
    ...
    def download_app_template(self, get):
        ...
        app_url = "{}/src/dk_app/k2panel/apps/templates/{}.zip".format(public.get_url(), get.app_name)
